...
2. User can **add**, **Get**, or **suggest passwords**.  
3. Passwords are **encrypted** before saving to a file to increase security.  
4. All data is stored locally in files named after usernames.  
...
```bash
git clone https://github.com/hamzasayed596/Password-Manager.git
```
